    ...
    return (
        <Dialog open={open} maxWidth="sm" fullWidth>
            <DialogContent sx={{ p: 5, textAlign: 'center' }} >
                ...
                <Typography lineHeight={1.3} variant='subtitle1' textAlign='center' sx={{ mt: 3 }}>Overriding the cooldown will add you to the queue, however you will be frozen until a TA approves you.</Typography>
            </DialogContent>
        </Dialog>
    );
}
