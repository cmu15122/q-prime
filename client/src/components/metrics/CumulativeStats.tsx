    ...
    <div>
      ...
      >
        <Grid sx={{px: 4, py: 4, alignItems: 'center', textAlign: 'center'}}>
          ...
          <Typography variant='h3' sx={{mt: 2}} fontWeight='bold'>2</Typography>
        </Grid>
        <Divider orientation="vertical" variant="middle" flexItem />
        <Grid sx={{px: 4, py: 4, alignItems: 'center', textAlign: 'center'}}>
          <Typography variant='h6' fontWeight='bold'>Average Time Spent per Question</Typography>
          <Typography variant='h3' sx={{mt: 2}} fontWeight='bold'>15</Typography>
        </Grid>
        <Divider orientation="vertical" variant="middle" flexItem />
        <Grid sx={{px: 4, py: 4, alignItems: 'center', textAlign: 'center'}}>
          <Typography variant='h6' fontWeight='bold'>Average No. of OH Visits Per Student Per Week</Typography>
          <Typography variant='h3' sx={{mt: 2}} fontWeight='bold'>3</Typography>
        </Grid>
      </Card>
    </div>
  );
